...
<div class="sub_content">
            ...
            <li><a class="active" href="<?php echo base_url() ?>index.php/tucasa/pages/Library"><i class="fas fa-book"></i>Library</a></li>
            <li><a href="<?php echo base_url() ?>index.php/tucasa/pages/Songs"> <i class="fas fa-music"></i>Songs</a></li>

            <li><a class="Logout" href="<?php echo base_url() ?>index.php/tucasa/user_authentication/logout"><i class="fas fa-sign-out-alt"></i>Logout</a></li>
           </ul>
...
<div class="navbar2">
 ...
 <ul>
<li><a class="active" href="books.php">Unabii</a></li>
<li><a href="mahusiano.php">Mahusiano & Ndoa</a></li>
<li><a href="afya.php">Afya</a></li>
<li><a href="lesoni.php">Lesoni</a></li>
