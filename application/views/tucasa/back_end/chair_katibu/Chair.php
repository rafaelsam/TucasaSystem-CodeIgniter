...
<div class="sub_content">
    <ul class="nav_ul">
     <li><a class="active" href="<?php echo base_url() ?>index.php/tucasa/pages/chair"><i class="fas fa-home"></i>Home</a></li>
...
echo "</div>";
?>
   <form method="post" action="<?php echo site_url("tucasa/pages/report")?>" style="padding:10px; margin-top:30px;">
...
<form method="post" action="<?php echo site_url("tucasa/pages/goal")?>" style="padding:10px; margin-top:30px;">
...
echo "</div>";
?>
<form method="post" action="<?php echo site_url("tucasa/pages/anoucement")?>" style="padding:10px; margin-top:30px;">
