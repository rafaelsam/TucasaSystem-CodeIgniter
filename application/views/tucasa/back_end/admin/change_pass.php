...
<div class="sub_content">
    ...
    <li><a href="<?php echo base_url() ?>index.php/tucasa/pages/home">Home</a></li>
     ...
     <li><a class="active" href="<?php echo base_url() ?>index.php/tucasa/data_management/change_pass">Change password</a></li>
...
<div class="right_pannel" style="float: right; width: 80%; background:white; height:500px; overflow:auto;">
    ...
    <h4 style="height:30px; width:100%; background:lightgreen; text-align:center; padding:5px;">Not yet completed</h4>
