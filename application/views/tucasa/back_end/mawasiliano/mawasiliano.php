...
<div class="left_pannel" style="float: left; width: 20%;background: #ccb6c1;">
        ...
        <div class="sub_content">
            <ul class="nav_ul">
            <li><a class="active" href="<?php echo base_url() ?>index.php/tucasa/pages/mawasiliano"><i class="fas fa-home"></i>Home</a></li>
             <li><a href="<?php echo base_url() ?>index.php/tucasa/pages_display/mawasiliano_report">My reports</a></li>
             <li><a href="<?php echo base_url() ?>index.php/tucasa/pages_display/mawasiliano_anoucement">Anoucements</a></li>
             <li><a href="<?php echo base_url() ?>index.php/tucasa/pages_display/mawasiliano_goal">Goals</a></li>
...
echo "</div>";
?>
   <form method="post" action="<?php echo site_url("tucasa/pages/mawasiliano_report")?>" style="padding:10px; margin-top:30px;">
...
<form method="post" action="<?php echo site_url("tucasa/pages/mawasiliano_goal")?>" style="padding:10px; margin-top:30px;">
...
echo "</div>";
?>
<form method="post" action="<?php echo site_url("tucasa/pages/mawasiliano_anoucement")?>" style="padding:10px; margin-top:30px;">
