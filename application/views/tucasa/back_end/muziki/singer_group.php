...
<div class="sub_content">
            ...
            <li><a  href="<?php echo base_url() ?>index.php/tucasa/pages/muziki"><i class="fas fa-home"></i>Home</a></li>
             ...
             <li><a class="active" href="<?php echo base_url() ?>index.php/tucasa/pages/singer_group">Groups/Choir</a></li>
...
<table id="t01" width=100%>
    ...
    if($nyimbo->num_rows() > 0){
        ...
        foreach($nyimbo->result() as $row){
            ...
            echo "<td>".$i."</td>";
            echo "<td>".$row->name."</td>";
            echo "<td><a class='view' href='viewdata?id=".$row->group_id."'>View</a></td>";
            echo "<td><a class='edit' href='updatedata?id=".$row->group_id."'>Edit</a></td>";
            echo "<td><a class='delete' href='deletedata?id=".$row->group_id."'>Delete</a></td>";
              echo "</tr>";
            $i++;
