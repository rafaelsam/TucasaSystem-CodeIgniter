...
<form class="fomu" action="action.php" style="padding:5px;">
     ...
     <input type="text" placeholder="melody">
     <input type="text" placeholder="sex">
     <input type="text" placeholder="singer name" name="search2">
...
<div class="sub_content">
            ...
            <li><a  href="<?php echo base_url() ?>index.php/tucasa/pages/muziki"><i class="fas fa-home"></i>Home</a></li>
             ...
             <li><a class="active" href="<?php echo base_url() ?>index.php/tucasa/pages/singers">View all Singers</a></li>
...
<div class="right_pannel" style="float: right; width: 80%; background:white;">
    ...
    if($nyimbo->num_rows() > 0){

        $i=1;
        foreach($nyimbo->result() as $row){
            ...
            echo "<td><a class='view' href='viewdata?id=".$row->singer_id."'>View</a></td>";
            echo "<td><a class='edit' href='updatedata?id=".$row->singer_id."'>Edit</a></td>";
            echo "<td><a class='delete' href='deletedata?id=".$row->singer_id."'>Delete</a></td>";
              echo "</tr>";
            $i++;
