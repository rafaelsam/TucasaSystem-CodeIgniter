...
<div class="sub_content">
            ...
            <li><a  href="<?php echo base_url() ?>index.php/tucasa/pages/muziki"><i class="fas fa-home"></i>Home</a></li>
             <li><a class="active" href="<?php echo base_url() ?>index.php/tucasa/pages/songs">Songs</a></li>
...
echo "<td>".$row->song_name."</td>";
echo "<td><a class='edit'href='updatedata?id=".$row->song_id."'>Edit</a></td>";
echo "<td><a class='delete' href='deletedata?id=".$row->song_id."'>Delete</a></td>";
  echo "</tr>";
$i++;
}
 ?>
