...
<div class="left_pannel" style="float: left; width: 20%;background: #ccb6c1;">
        ...
        <div class="sub_content">
            <ul class="nav_ul">
             <li><a class="active" href="<?php echo base_url() ?>index.php/tucasa/pages/auditor"><i class="fas fa-home"></i>Home</a></li>
             <li><a href="<?php echo base_url() ?>index.php/tucasa/pages_display/auditor_report">My reports</a></li>
...
?>
   ...
   <form method="post" action="<?php echo site_url("tucasa/pages/auditor_report")?>" style="padding:10px; margin-top:30px;">
...
<form method="post" action="<?php echo site_url("tucasa/pages/auditor_goal")?>" style="padding:10px; margin-top:30px;">
...
echo "</div>";
?>
<form method="post" action="<?php echo site_url("tucasa/pages/auditor_anoucemet")?>" style="padding:10px; margin-top:30px;">
