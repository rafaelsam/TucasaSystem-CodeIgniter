...
<head>
    ...
    <title>Auditor Anoucements</title>
    <style>
...
<div class="left_pannel" style="float: left; width: 20%;background: #ccb6c1;">
        ...
        <ul class="nav_ul">
             ...
             <li><a class="active" href="<?php echo base_url() ?>index.php/tucasa/pages_display/auditor_anoucement">Anoucements</a></li>
...
<table id="t01" width=100%>
  ...
  echo "<td><a class='edit'href='update_anoucememnt?id=".$row->id."'>Edit</a></td>";
  echo "<td><a class='delete' href='delete_anoucememnt?id=".$row->id."'>Delete</a></td>";
    echo "</tr>";
  $i++;
  }
   ?>
