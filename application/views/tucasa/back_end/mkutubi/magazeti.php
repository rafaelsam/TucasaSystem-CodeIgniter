...
<li><a href="<?php echo base_url() ?>index.php/tucasa/pages/afya">Afya</a></li>
...
<li><a class="active" href="<?php echo base_url() ?>index.php/tucasa/pages/magazeti">Magazeti & Vijuzuu</a></li>
