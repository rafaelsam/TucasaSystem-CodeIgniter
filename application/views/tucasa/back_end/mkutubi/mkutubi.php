...
<div class="left_pannel" style="float: left; width: 20%;background: #ccb6c1;">
        ...
        <div class="sub_content">
            ...
            <ul class="nav_ul">
            <li><a class="active" href="<?php echo base_url() ?>index.php/tucasa/pages/mkutubi">Home</a></li>
            <li><a  href="<?php echo base_url() ?>index.php/tucasa/pages/books">View uploaded Books</a></li>
...
<h1 style="text-align:center;"><u>Add new Book</u></h1>
<?php
if (isset($book_message)) {
...
echo "</div>";
?>
<form method="post" action="<?php echo site_url("tucasa/pages/new_book")?>" style="padding:10px; margin-top:30px;">

<?php echo form_error('book_name', '<div class="error_msg">', '</div>')?>
<input type="text" name="book_name" placeholder="Book name">


<?php echo form_error('publisher_name', '<div class="error_msg">', '</div>')?>
<input type="text" name="publisher_name" placeholder="Publisher name">


<?php echo form_error('author_name', '<div class="error_msg">', '</div>')?>
<input type="text" name="author_name" placeholder="Author name">
<br><br>
<br>


<?php echo form_error('Category', '<div class="error_msg">', '</div>')?>
<select name="Category" id="Category">
<option value="">----Category-----</option>
<option value="Roho ya unabii">Roho ya unabii</option>
<option value="Lesoni">Lesoni</option>
<option value="Afya">Afya</option>
<option value="Mahusiano na ndoa">Mahusiano na ndoa</option>
<option value="Magazeti/Vijuzuu">Magazeti/Vijuzuu</option>
<option value="Makala">Makala</option>
</select>

Book file: <input name="file" type="file">
...
echo "</div>";
?>
   <form method="post" action="<?php echo site_url("tucasa/pages/mkutubi_report")?>" style="padding:10px; margin-top:30px;">
...
<form method="post" action="<?php echo site_url("tucasa/pages/mkutubi_goal")?>" style="padding:10px; margin-top:30px;">
...
echo "</div>";
?>
<form method="post" action="<?php echo site_url("tucasa/pages/mkutubi_anoucement")?>" style="padding:10px; margin-top:30px;">
