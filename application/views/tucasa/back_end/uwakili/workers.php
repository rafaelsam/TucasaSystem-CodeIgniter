...
<div class="sub_content">
            ...
            <li><a   href="<?php echo base_url() ?>index.php/tucasa/pages/uwakili">Home</a></li>
             ...
             <li><a class="active" href="<?php echo base_url() ?>index.php/tucasa/pages/workers">Workers</a></li>
...
<table id="t01" width=100%>
    ...
    if($employee->num_rows() > 0){
        ...
        foreach($employee->result() as $row){
            ...
            echo "<td><a class='view' href='viewdata?id=".$row->worker_id."'>View</a></td>";
            echo "<td><a class='edit' href='updatedata?id=".$row->worker_id."'>Edit</a></td>";
            echo "<td><a class='delete' href='deletedata?id=".$row->worker_id."'>Delete</a></td>";
              echo "</tr>";
            $i++;
