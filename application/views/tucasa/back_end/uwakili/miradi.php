...
<div class="sub_content">
            ...
            <li><a   href="<?php echo base_url() ?>index.php/tucasa/pages/uwakili">Home</a></li>
             <li><a class="active" href="<?php echo base_url() ?>index.php/tucasa/pages/miradi">Investment</a></li>
...
<table id="t01" width=100%>
    ...
    if($uwakili->num_rows() > 0){
        ...
        foreach($uwakili->result() as $row){
            ...
            echo "<td>".$i."</td>";
            echo "<td>".$row->name."</td>";
            echo "<td><a class='edit' href='updatedata?id=".$row->investment_id."'>Edit</a></td>";
            echo "<td><a class='delete' href='deletedata?id=".$row->investment_id."'>Delete</a></td>";
              echo "</tr>";
            $i++;
