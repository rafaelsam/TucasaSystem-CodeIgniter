...
<head>
    ...
    <title>Investment_analysis</title>
    <style>
...
<!-- Navbar2 -->
 ...
 <ul>
 <li><a class="active" href="<?php echo base_url() ?>index.php/tucasa/pages/Investment_analysis">Purchases</a></li>
<li><a href="<?php echo base_url() ?>index.php/tucasa/pages/sales">Sales</a></li>
...
<table id="t01" width=100%>
    ...
    if($purchase->num_rows() > 0){
        ...
        foreach($purchase->result() as $row){
            ...
            echo "<td><a class='view' href='viewdata?id=".$row->purchase_id."'>View</a></td>";
            echo "<td><a class='edit' href='updatedata?id=".$row->purchase_id."'>Edit</a></td>";
            echo "<td><a class='delete' href='deletedata?id=".$row->purchase_id."'>Delete</a></td>";
              echo "</tr>";
            $i++;
